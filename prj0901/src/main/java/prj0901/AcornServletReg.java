...
public class AcornServletReg extends HttpServlet {
	...
	@Override
	protected void doGet(HttpServletRequest request, HttpServletResponse respense)
		...
		request.getRequestDispatcher("WEB-INF/views/ok.jsp").forward(request, respense);
